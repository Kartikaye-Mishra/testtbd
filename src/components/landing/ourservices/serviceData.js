import images from '../../../images/images.js'
 const data = [
    ...
    desc:"Cysco's web developers help brands succeed in the ever-changing digital landscape by creating customer-focused, customer-centric website solutions."

},
{
    imgURL:images.fullStack,
    title:'Full Stack Development',
    desc:'Full-stack developers Cysco are skilled in everything from the concept and idea to the finished product.'
    ...
    desc:'We offer all the skills necessary for the success of your eCommerce project under one roof with Cysco.'
